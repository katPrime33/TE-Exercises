...
public class SleepInTest {
    ...
    */
    ...
    /*
    Because we don't want to duplicate code, instantiation of SleepIn object
    in setup()
     */
    ...
    /*
    Don't have to have after, but put here for example - only include if you
    need to clean up after a test
     */
    ...
    @Test
    public void do_sleep_in_when_on_vacation_and_is_weekday(){
        //Arrange
        //Act
        boolean actualResult = sleepIn.sleepIn(true, true);
        //Assert
        Assert.assertTrue("Do sleep in on weekday when you are on vacation", actualResult);
    }

    @Test
    public void do_sleep_in_if_is_weekend_and_not_on_vacation(){
        //Arrange
        //Act
        boolean actualResult = sleepIn.sleepIn(false,false);
        //Assert
        Assert.assertTrue("Sleep away! Enjoy your weekend!", actualResult);
    }

    @Test
    public void do_sleep_in_if_on_vacation_and_is_not_weekeday(){
        //Arrange
        //Act
        boolean actualResult = sleepIn.sleepIn(false, true);
        //Assert
        Assert.assertTrue("Sleep away! Enjoy your vacation!!", actualResult);
    }
