...
public class JdbcEmployeeDaoTest extends BaseDaoTest {
    ...
    public void getEmployeesByProjectId_returns_all_employees_for_project() {
        List<Employee> employees = sut.getEmployeesByProjectId(1);
        ...
        employees = sut.getEmployeesByProjectId(2);
        Assert.assertEquals("getEmployeesByProjectId returned wrong number of employees",
            2, employees.size());
        ...
        employees = sut.getEmployeesByProjectId(99);
    ...
    @Test
        ...
        sut.removeEmployeeFromProject(2, 3);
        List<Employee> employees = sut.getEmployeesByProjectId(2);
