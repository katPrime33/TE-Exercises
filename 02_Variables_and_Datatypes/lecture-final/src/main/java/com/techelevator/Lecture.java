...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int percentageFromBatteryLeft = 88;
		System.out.println(percentageFromBatteryLeft + "%");
		System.out.println(percentageFromBatteryLeft);
		/*
		...
		*/
		...
		/*
		11. Create a double that holds the addition of 12.3 and 32.1. //44.4
		*/
