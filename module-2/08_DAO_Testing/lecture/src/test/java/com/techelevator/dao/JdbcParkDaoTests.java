...
public class JdbcParkDaoTests extends BaseDaoTests {
    ...
    public void setup() {
        ...
        testPark = new Park(0, "Test Park", LocalDate.parse("2022-08-11"), 200, false);
    }
    ...
    public void getParksByState_returns_empty_list_for_abbreviation_not_in_db() {
        List<Park> parks = sut.getParksByState("MM");
    ...
    public void updated_park_has_expected_values_when_retrieved() {
        ...
        parkToUpdate.setParkName("UpdatedPark");
        parkToUpdate.setDateEstablished(LocalDate.parse("2022-08-11"));
        parkToUpdate.setArea(150);
