...
function addReview(parent, review) {
  ...
  parent.appendChild(productReview);
...
displayReviews();
//add name of reviewer to the review
addReviewer();
//adds star ratings for each review
addRating();
//adds title for each review
addTitle();
//adds the product review for each review
addReview();