...
SELECT name, area, population
FROM city
WHERE state_name != 'California' OR state_name != 'Florida';
...
-- BETWEEN
-- Write a query to retrieve the names and areas of parks of at least 
-- 100 sq. kilometers but no more than 200 sq. kilometers
SELECT name, area
FROM park_name
