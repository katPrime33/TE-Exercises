...
public class Exercise06_ElectricBill {
    ...
    - Start off setting a variable to hold the netUsage value. If they returned more than they used, then netUsage will be negative and we will use that negative value to determine their credit.
